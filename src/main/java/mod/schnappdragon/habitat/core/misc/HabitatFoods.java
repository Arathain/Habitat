...
public class HabitatFoods {
    public static final FoodProperties KABLOOM_PULP = new FoodProperties.Builder().nutrition(2).saturationMod(0.3F).effect(() -> new StatusEffectInstance(HabitatEffects.BLAST_ENDURANCE.get(), 400, 0), 1.0F).fast().build();
